...
def browsegeo_usage():
    usage='''
       ...
       Example:
           python PROG -i GSE64403 -d /path2experiments
           OR python PROG --geoid=GSE64403 --destdir=/path2experiments
           OR python PROG --geoid=GSE64403 --destdir=/path2experiments -c
